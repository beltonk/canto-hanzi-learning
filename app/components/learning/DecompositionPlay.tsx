      ...
      {allCharacters.length > 1 && (
        <div className="bg-white rounded-2xl shadow-[0_4px_16px_rgba(0,0,0,0.06)] overflow-hidden">
          <button
            ...
            className="w-full px-4 py-3 flex items-center justify-between text-left hover:bg-[#F0FFF4] transition-colors"
          >
            ...
            <span className={`text-xl text-[#98D8AA] transition-transform ${showCharList ? 'rotate-180' : ''}`}>
              ▼
            </span>
          </button>
          {showCharList && (
